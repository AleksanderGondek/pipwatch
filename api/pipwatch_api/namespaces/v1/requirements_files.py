...
requirements_file_repr_structure = {  # pylint: disable=invalid-name
    ...
    "requirements": fields.List(fields.Nested(requirement_repr_structure))
}
requirements_file_repr = requirements_files_namespace.model("RequirementsFile",  # pylint: disable=invalid-name
                                                            requirements_file_repr_structure)
...
class RequirementsFiles(Resource):
    ...
    @requirements_files_namespace.marshal_list_with(requirements_file_repr)
    def get(self):
