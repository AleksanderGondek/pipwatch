...
class Project(DATABASE.Model):
    ...
    def __init__(self, name: str = "", namespace: str = "", url: str = "", namespace_id: str = "") -> None:
    ...
    def __repr__(self) -> str:
        ...
        return "{0}({1!r},{2!r},{3!r})".format(self.__class__.__module__ + "." + self.__class__.__name__,
                                               self.id, self.name, self.namespace_id)
...
class RequirementsFile(DATABASE.Model):
    ...
    def __repr__(self) -> str:
        """Return class instance representation."""
        return "{0}({1!r},{2!r},{3!r},{4!r})".format(self.__class__.__module__ + "." + self.__class__.__name__,
                                                     self.id, self.full_path, self.status, self.project_id)
...
class Requirement(DATABASE.Model):
    ...
    def __repr__(self) -> str:
        """Return class instance representation."""
        return "{0}({1!r},{2!r},{3!r},{4!r},{5!r},{6!r})".format(self.__class__.__module__ + "." +
